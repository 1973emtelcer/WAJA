...
require([
    ...
    function (Map, Extent, ArcGISDynamicMapServiceLayer, FeatureLayer ,
             BasemapToggle, Scalebar, Legend, ready, parser, on,
...
// @formatter:on
        ...
        ready(function () {
            ...
            var extentInitial = new Extent ({
                "xmin":-15140145.509182617,
                "ymin":3472689.084477771,
                "xmax":-11661954.974094883,
                "ymax":6143704.60087426,
                "spatialReference":{
                    "wkid":102100
            }
            });
             ...
             */
            var lyrQueakes = new FeatureLayer ("https://services.arcgis.com/ue9rwulIoeLEI9bj/ArcGIS/rest/services/Earthquakes/FeatureServer/0");
            lyrQueakes. setDefinitionExpression ("MAGNITUDE >=2.0");
            /*
            * Step: Revise code to use the addLayers() method
             * mapMain.addLayer (lyrUSA);
               mapMain.addLayer (lyrQueakes)
            */
            mapMain. addLayers ([lyrUSA, lyrQueakes]);
             ...
             */
            var dijitScalerbar =new Scalebar ({
                map: mapMain,
                scalebarUnit: "dual",
